            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className="flex min-h-[62px] flex-col items-center justify-center rounded-2xl px-2 py-2 text-[10px] font-semibold text-white/70 hover:bg-white/10 hover:text-white"
                >
